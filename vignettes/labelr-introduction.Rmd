...
our value-labeled variables will (must) have one unique label (one-to-one                                mapping), and any unique values that were not explicitly assigned a label were 
...
```{r}
df_temp <- add_quant_labs(data = df, 
                          vars = "x", 
                          qtiles = 5, 
                          partial = TRUE)
