...
When using `add_val_labs`, each distinct value label must have a one-to-one 
mapping with a distinct value of the variable (i.e., no two values can share the 
same label, and no two labels can be applied to the same value). We'll relax this 
