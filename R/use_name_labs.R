...
#'
#' @details
#' Note: `unl` is a compact alias for `use_name_labs`: they do the same thing,
#' and the former is easier to type
#'
#' `use_name_labs` works with `add_name_labs`, `get_name_labs`, `use_var_names`,
...
#' these labels with variables in a data.frame, `use_name_labs` applies or
...
use_name_labs <- function(data, vars = NULL) {
