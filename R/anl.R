...
#' name label for a column called "wgt"). `anl `takes a data.frame and
...
#' applied. If NULL, labs arg must also be NULL and name.labs cannot be NULL. If
#' non-NULL, labs must also be non-NULL and name.labs must be NULL.
#' @param labs the proposed variable name labels to applied to the columns
#' (variables). If NULL, vars arg must also be NULL and name.labs cannot be NULL.
#' If non-NULL, vars arg must also be non-NULL and name.labs must be NULL.
