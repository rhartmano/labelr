#' (Alias for) `use_val_labs()`
#'
#' @description
#' Replace the actual values of data.frame variables with the corresponding
#' value labels (previous assigned using `add_val_labs` or `add_val1`).
#'
#' @details
#' `uvl` is an alias for `use_val_labs`. See the `use_val_labs` documentation
