#' (Alias for) `get_val_labs()`
#'
#' @description
#' For a variable-value-labeled data.frame, `gvl` returns a derivative
#' data.frame that features the variable name, value, and associated value
#' label for each value-labeled variable (one row per unique value per value-
#' labeled variable).
#'
#' @details
